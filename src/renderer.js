...
function handleFileChanged(filePath) {
    ...
    // Si el watch mode está activo y es un archivo de test, podrías ejecutarlo automáticamente
    if (appState.watchMode) {
        const fileName = filePath.split(/[/\\]/).pop();
        // Aquí podrías implementar lógica para auto-ejecutar tests
    }
}
